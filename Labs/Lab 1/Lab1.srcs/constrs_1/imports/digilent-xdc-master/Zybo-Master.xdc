...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { b(0) }]; #IO_L19N_T3_VREF_35 Sch=SW0
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { a(0) }];  #IO_L24P_T3_34 Sch=SW1
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { b(1) }]; #IO_L4N_T0_34 Sch=SW2
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { a(1) }]; #IO_L9P_T1_DQS_34 Sch=SW3
...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { carry_out }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
